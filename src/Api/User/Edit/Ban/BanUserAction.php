...
class BanUserAction extends TaskWaveAction
{
    ...
    protected function execute(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        $this->userService->banUser($requesterId, $userId);

        return TaskWaveResult::from(JsonResult::from('User has been banned.'))->getResponse($response);
    }
}
